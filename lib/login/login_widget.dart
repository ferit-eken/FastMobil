            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(15.0, 2.0, 15.0, 6.0),
                    child: Container(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        if (UserGroup.loginCall.succeeded(
                                          ...
                                          setState(() {
                                            FFAppState().UserInfo = (_model
                                                    .apiResultwz0?.jsonBody ??
                                                '');
                                            ...
                                            FFAppState().girisFirmaKodu = _model
                                                .txtFirmakoduController.text;
                                            FFAppState().girisKullanici = _model
