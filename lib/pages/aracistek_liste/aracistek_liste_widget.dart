...
class _AracistekListeWidgetState extends State<AracistekListeWidget> {
  late AracistekListeModel _model;
                                    ...
                                    child: Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            _model.apiResultqit = await PtsGroup
                                                .aracSorguCall
                                                .call(
                                              db: FFAppState().veritabani,
                                              command: 'HESAP',
