...
class AboneDetayWidget extends StatefulWidget {
  ...
  @override
  _AboneDetayWidgetState createState() => _AboneDetayWidgetState();
}

class _AboneDetayWidgetState extends State<AboneDetayWidget> {
  late AboneDetayModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AboneDetayModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (widget.cari != null) {
        setState(() {
          _model.txtUnvanController?.text = getJsonField(
            widget.cari,
            r'''$.Unvan''',
          ).toString().toString();
        });
        setState(() {
          _model.chCarigrupValueController?.value = getJsonField(
            widget.cari,
            r'''$.CariGrup''',
          ).toString().toString();
        });
        setState(() {
          _model.chDurumValueController?.value = getJsonField(
            widget.cari,
            r'''$.Durum''',
          );
        });
        ...
        setState(() {
          _model.txtMailController?.text = getJsonField(
            widget.cari,
            r'''$.Mail''',
          ).toString().toString();
        });
        setState(() {
          _model.txtAdresController?.text = getJsonField(
            widget.cari,
            r'''$.Adres''',
          ).toString().toString();
        });
        setState(() {
          _model.txtNotController?.text = getJsonField(
            widget.cari,
            r'''$.CariNot''',
          ).toString().toString();
        });
          ...
          actions: [
            Padding(
              ...
              child: InkWell(
                ...
                onTap: () async {
                  _model.apiResultcariupdate =
                      await CariGroup.cariKayitCall.call(
                    db: FFAppState().veritabani,
                    kod: _model.txtKodController.text,
                    ad: '-',
                    soyad: '-',
                    unvan: _model.txtUnvanController.text,
                    cariGrup: _model.chCarigrupValue,
                    gsm: _model.txtTelefonController.text,
                    mail: _model.txtMailController.text,
                    durum: _model.chDurumValue,
                    karaListe: 0,
                    adres: _model.txtAdresController.text,
                    cariNot: _model.txtNotController.text,
                    createdUserId: FFAppState().UserId,
                    command: 'UPDATE',
                  );
                  if (CariGroup.cariKayitCall.successed(
                                  ...
                                  Padding(
                                    ...
                                    child: FutureBuilder<ApiCallResponse>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        final chCarigrupGetALLResponse =
                                            snapshot.data!;
                                        return FlutterFlowDropDown<String>(
                                          controller: _model
                                                  .chCarigrupValueController ??=
                                              FormFieldController<String>(
                                            _model.chCarigrupValue ??= '1',
                                          ),
                                          options: (getJsonField(
                                            chCarigrupGetALLResponse.jsonBody,
                                            r'''$.data[:].Kod''',
                                          ) as List)
                                          ...
                                          textStyle:
                                              FlutterFlowTheme.of(context)
                                                  .bodyMedium,
                                          hintText: 'Abone grubunu seçiniz',
                                          icon: Icon(
