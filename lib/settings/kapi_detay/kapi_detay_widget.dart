                              ...
                              children: [
                                ...
                                Theme(
                                  ...
                                  child: Checkbox(
                                    ...
                                    onChanged: (newValue) async {
                                      setState(() =>
                                          _model.chGeciskaydiValue = newValue!);
                                    },
                                    activeColor:
                                        FlutterFlowTheme.of(context).primary,
                                    checkColor:
                                ...
                                FutureBuilder<ApiCallResponse>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return FlutterFlowDropDown<String>(
                                      controller:
                                          _model.txtKameraValueController ??=
                                              FormFieldController<String>(
                                        _model.txtKameraValue ??= getJsonField(
                                          widget.kapi,
                                          r'''$.GirisKameraId''',
                                        ).toString(),
                                      ),
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    FlutterFlowDropDown<int>(
                                      controller:
                                          _model.txtTetiknoValueController ??=
                                              FormFieldController<int>(
                                        _model.txtTetiknoValue ??= getJsonField(
                                          widget.kapi,
                                          r'''$.TetikNo''',
                                        ),
                                      ),
                              ...
                              children: [
                                ...
                                FutureBuilder<ApiCallResponse>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return FlutterFlowDropDown<String>(
                                      controller:
                                          _model.txtLedpanelValueController ??=
                                              FormFieldController<String>(
                              ...
                              children: [
                                ...
                                FutureBuilder<ApiCallResponse>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return FlutterFlowDropDown<String>(
                                      controller:
                                          _model.txtKasalarValueController ??=
                                              FormFieldController<String>(
                                        _model.txtKasalarValue ??= getJsonField(
                                          widget.kapi,
                                          r'''$.KasaKodu''',
                                        ).toString(),
                                      ),
                                    ...
                                    return FlutterFlowDropDown<String>(
                                      controller:
                                          _model.txtBankaValueController ??=
                                              FormFieldController<String>(
                                        _model.txtBankaValue ??= getJsonField(
                                          widget.kapi,
                                          r'''$.BankaKodu''',
                                        ).toString(),
                                      ),
                              ...
                              children: [
                                ...
                                FutureBuilder<ApiCallResponse>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return FlutterFlowDropDown<String>(
                                      controller:
                                          _model.chPoscihaziValueController ??=
                                              FormFieldController<String>(
                              ...
                              children: [
                                ...
                                Theme(
                                  ...
                                  child: Checkbox(
                                    ...
                                    onChanged: (newValue) async {
                                      setState(() =>
                                          _model.chAbonegecisValue = newValue!);
                                    },
                                    activeColor:
                                        FlutterFlowTheme.of(context).primary,
                                    checkColor:
