...
class KullaniciDetayWidget extends StatefulWidget {
  ...
  @override
  _KullaniciDetayWidgetState createState() => _KullaniciDetayWidgetState();
}

class _KullaniciDetayWidgetState extends State<KullaniciDetayWidget> {
  late KullaniciDetayModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => KullaniciDetayModel());
          ...
          actions: [
            Padding(
              ...
              child: InkWell(
                ...
                onTap: () async {
                  _model.apiResultgar =
                      await SettingsGroup.personelUpdateCall.call(
                    db: FFAppState().veritabani,
                    tablename: 'Personel',
                    keyField: 'Kod',
                    keyvalue: _model.txtKodController.text,
                    command: 'UPDATE',
                    kod: _model.txtKodController.text,
                    ad: _model.txtAdController.text,
                    soyad: _model.txtSoyadController.text,
                    username: _model.txtUsernameController.text,
                    sifre: _model.txtSifreController.text,
                    gsm: _model.txtGsmController.text,
                  );
                  if (SettingsGroup.personelUpdateCall.successed(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    validator: _model.txtKodControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ],
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    validator: _model.txtAdControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ],
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    validator: _model.txtGsmControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ],
