...
import 'pos_cihazlari_model.dart';
export 'pos_cihazlari_model.dart';

class PosCihazlariWidget extends StatefulWidget {
  const PosCihazlariWidget({Key? key}) : super(key: key);

  @override
  _PosCihazlariWidgetState createState() => _PosCihazlariWidgetState();
}

class _PosCihazlariWidgetState extends State<PosCihazlariWidget> {
  late PosCihazlariModel _model;
