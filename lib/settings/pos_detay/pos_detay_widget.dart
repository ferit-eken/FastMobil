...
class PosDetayWidget extends StatefulWidget {
  ...
  @override
  _PosDetayWidgetState createState() => _PosDetayWidgetState();
}

class _PosDetayWidgetState extends State<PosDetayWidget> {
  late PosDetayModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PosDetayModel());
          ...
          actions: [
            Padding(
              ...
              child: InkWell(
                ...
                onTap: () async {
                  _model.apiResultgar = await SettingsGroup.posUpdateCall.call(
                    ...
                    posAdi: _model.txtCihazadiController.text,
                    marka: _model.txtMarkaValue,
                    baglantiTipi: _model.txtBaglantitipiValue,
                    ...
                    posKey: _model.txtPoskeyController.text,
                  );
                  if (SettingsGroup.posUpdateCall.successed(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                FlutterFlowDropDown<String>(
                                  controller:
                                      _model.txtBaglantitipiValueController ??=
                                          FormFieldController<String>(
                                    _model.txtBaglantitipiValue ??=
