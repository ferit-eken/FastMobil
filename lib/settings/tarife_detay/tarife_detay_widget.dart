...
class TarifeDetayWidget extends StatefulWidget {
  ...
  @override
  _TarifeDetayWidgetState createState() => _TarifeDetayWidgetState();
}

class _TarifeDetayWidgetState extends State<TarifeDetayWidget> {
  late TarifeDetayModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TarifeDetayModel());
          ...
          actions: [
            Padding(
              ...
              child: InkWell(
                ...
                onTap: () async {
                  _model.apiResultgar =
                      await SettingsGroup.aboneTarifeUpdateCall.call(
                    db: FFAppState().veritabani,
                    tablename: 'AboneTarife',
                    keyField: 'Id',
                    keyvalue: _model.txtIdController.text,
                    command: 'UPDATE',
                    id: int.tryParse(_model.txtIdController.text),
                    otoparkId: _model.txtOtoparkValue,
                    tarifeAdi: _model.txtAdController.text,
                    aracTipId: _model.txtAractipiValue,
                    odemeGecerlilikSuresi:
                        _model.txtOdemegecerlilikController.text,
                    gunlukUcretsizLimitSayi:
                        int.tryParse(_model.txtUcretsizlimitController.text),
                    gunDonusumSaati: _model.txtGundonusumController.text,
                  );
                  if (SettingsGroup.aboneTarifeUpdateCall.successed(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return FlutterFlowDropDown<String>(
                                      controller:
                                        ...
                                        _model.txtOtoparkValue ??= getJsonField(
                                          widget.tarife,
                                          r'''$.OtoparkId''',
                                        ).toString(),
                                      ),
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    validator: _model
                                        .txtUcretsizlimitControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ],
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Container(
                                  width: 200.0,
                                  child: TextFormField(
                                    controller: _model.txtGundonusumController,
                                    autofocus: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      labelStyle: FlutterFlowTheme.of(context)
                                    ...
                                    validator: _model
                                        .txtGundonusumControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ],
