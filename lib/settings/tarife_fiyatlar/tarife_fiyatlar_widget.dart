...
class TarifeFiyatlarWidget extends StatefulWidget {
  ...
  @override
  _TarifeFiyatlarWidgetState createState() => _TarifeFiyatlarWidgetState();
}

class _TarifeFiyatlarWidgetState extends State<TarifeFiyatlarWidget> {
  late TarifeFiyatlarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TarifeFiyatlarModel());
                    ...
                    Padding(
                      ...
                      child: FutureBuilder<ApiCallResponse>(
                        future: (_model.apiRequestCompleter ??= Completer<
                                ApiCallResponse>()
                              ..complete(SettingsGroup.getFilterDataCall.call(
                                db: FFAppState().veritabani,
                                tablename: 'AboneTarifeFiyat',
                                filtre: 'TarifeId=${getJsonField(
                                  widget.tarife,
                                  r'''$.Id''',
                                ).toString()}',
                              )))
