...
class _UrunlerWidgetState extends State<UrunlerWidget>
    with TickerProviderStateMixin {
  late UrunlerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UrunlerModel());
                      ...
                      child: FutureBuilder<ApiCallResponse>(
                        future: (_model.apiRequestCompleter ??=
                                Completer<ApiCallResponse>()
                                  ..complete(SettingsGroup.getALLCall.call(
                                    db: FFAppState().veritabani,
                                    tablename: 'Urun',
                                  )))
                            .future,
